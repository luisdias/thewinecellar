...
/**
 * Grapetypes Controller
 *
 * @property Grapetype $Grapetype
 */
class GrapetypesController extends AppController {
public $name = 'Grapetypes';
public $paginate = array('limit'=>10, 'order'=>array('grape_name'=>'asc'));
public $fk = null;

public function __construct( $request = NULL, $response = NULL ) {
    parent::__construct($request,$response);
    if ( empty($this->translatedSingularName) )
            $this->translatedSingularName = __('Grape type',true);

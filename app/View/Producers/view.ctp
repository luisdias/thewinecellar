...
<h2><?php  echo __('Producer');?></h2>
	<dl>
		<dt><?php echo __('Producer Name'); ?></dt>
		<dd>
			<?php echo h($producer['Producer']['producer_name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Country'); ?></dt>
		<dd>
			<?php echo $this->Html->link($countries[$producer['Country']['id']], array('controller' => 'countries', 'action' => 'view', $producer['Country']['id'])); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<?php echo $this->element('related_wines',array('currentModel' => $producer)) ; ?>
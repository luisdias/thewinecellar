...
<?php echo $this->Form->create('Producer');?>
	<fieldset>
		<legend><?php echo $theAction . ' ' . __('Producer'); ?></legend>
	<?php
		echo $this->Form->input('id');
		echo $this->Form->input('producer_name',array('size'=>'45','title'=>__('Enter the producer name',true)));

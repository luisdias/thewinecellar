 ...
 */
?>
<div class="winetypes view">
<h2><?php  echo __('Winetype');?></h2>
	<dl>
		<dt><?php echo __('Wine type Name'); ?></dt>
		<dd>
			<?php echo h($winetype['Winetype']['winetype_name']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<?php echo $this->element('related_wines',array('currentModel' => $winetype)) ; ?>
 ...
 */
?>
<div class="grapetypes view">
<h2><?php  echo __('Grape type');?></h2>
	<dl>
		<dt><?php echo __('Grape Name'); ?></dt>
		<dd>
			<?php echo h($grapetype['Grapetype']['grape_name']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<?php echo $this->element('related_wines',array('currentModel' => $grapetype)) ; ?>